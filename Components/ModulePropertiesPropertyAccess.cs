namespace DNNDataTables.Modules.Components
{
    ...
    public class ModulePropertiesPropertyAccess : IPropertyAccess
    {
        ...
        public string GetProperty(string propertyName, string format, CultureInfo formatProvider, UserInfo accessingUser, Scope accessLevel, ref bool propertyNotFound)
        {
            ...
            switch (propertyName.ToLower())
            {
                case "all":
                    ...
                    properties.routingWebAPI = "/DesktopModules/DNNDataTables/API/";
        ...
        private Dictionary<string, string> GetResources(ModuleInfo module)
        {
            ...
            System.IO.FileInfo fi = new FileInfo(HttpContext.Current.Server.MapPath("~/" + _moduleContext.Configuration.ModuleControl.ControlSrc + "." + currentLanguage + ".resx"));
